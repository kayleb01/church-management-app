            ...
            <div class="card card-tabs">
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-three-notes-tab" data-toggle="pill" href="#custom-tabs-three-notes" role="tab" aria-controls="custom-tabs-three-notes" aria-selected="false"  @click="fetch(user.id)"><i class="fa fa-file"></i> Notes</a>
                  </li>
                  <li class="nav-item">
...
<script>
export default{
	props: ['user', 'people', 'follow', 'users'],
    ...
    methods:{
		 updatenote(user){
            ...
            this.loading = true;
            this.form.patch(`/note/${this.form.id}/edit`)
            .then(() => {
