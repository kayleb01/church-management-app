...
<div style="min-height: 822px;" class="content-wrapper">
  <section class="content-header">
    <h1><i class="fa fa-dashboard"></i> New Group</h1>
  </section>
	...
	<div class="box">
        <div class="box-body padding">
			<form method="POST" class="form-horizontal" action="{{url('admin/store')}}" enctype="multipart/form-data">
                ...
                <div class="">
                    <input name="gname" id="gname" placeholder="Group name" class="form-control mb-3" type="text" required>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="leader">Leader</label>
                <div class="">
                    <input name="leader" id="leader" placeholder="Leader" class="form-control mb-3" type="text" required>
                </div>
                <div class="form-group">
